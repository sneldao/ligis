...
export default async function HomePage({
  ...
  return (
    <>
      ...
      <HomeField>
        <main
          id="how"
          className="pointer-events-auto mx-auto max-w-5xl scroll-mt-24 px-8 pt-28 pb-16 sm:pt-36 sm:pb-24"
        >
          ...
          <section className="mt-16">
            ...
            <p className="mt-10 max-w-2xl font-serif text-xl leading-relaxed text-ink-soft">
              ...
              bridging &mdash; with counterparties they&rsquo;ve never met.
              Ligis tells you if that stranger is trustworthy, in one on-chain
              read, before the transaction leaves your wallet.
            </p>
            <p className="mt-6 max-w-2xl font-serif text-base italic leading-relaxed text-ink-quiet">
              {stats.ok ? (
                ...
                <>
                  <span className="not-italic text-ink-soft">{chain.name}</span>{" "}
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-[18rem_1fr]">
              <div>
                ...
                <p className="mt-4 font-serif text-sm italic leading-relaxed text-ink-quiet">
                  This is the same read your agent would make before sending a
        ...
        <section id="croo" className="mt-8 scroll-mt-24 sm:mt-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-[18rem_1fr]">
            <div>
              ...
              <p className="mt-6 font-serif text-base leading-relaxed text-ink-soft">
                Your agent is about to transact with a counterparty it found on
                the{" "}
                <a
                ...
                . Before it pays, hire Ligis to check whether that counterparty
                holds the credentials the job requires. The risk report comes
                back in seconds: a 0&ndash;100 score, a pass/warn/fail verdict,
                and the breakdown of why.
              </p>
              <ul className="mt-4 space-y-2 font-serif text-sm leading-relaxed text-ink-soft">
                ...
                <li className="flex items-baseline gap-3">
                  ...
                  &mdash; credential issuance, on-chain tx ($1.00)
                </li>
              </ul>
            </div>
  ...
  "signals": [...]               // cross-cutting signals
              ...
              <p className="font-serif text-xs italic leading-relaxed text-ink-quiet">
                ...
                <code className="font-mono not-italic">kyc.basic</code>, weight
                4) drags the score 4&times; harder than a low-stakes one (like{" "}
                <code className="font-mono not-italic">data.premium</code>,
                weight 1). A credential issued 5 minutes ago gets a maturity
                penalty. A critical capability with TTL below half the minimum
        ...
        <section id="compose" className="mt-32 scroll-mt-24 sm:mt-44">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-[18rem_1fr]">
            <div>
              ...
              <p className="mt-6 font-serif text-base leading-relaxed text-ink-soft">
                You don&rsquo;t need Ligis&rsquo; permission, SDK, or API key.
                Call <code className="font-mono text-ink">isCapable</code>{" "}
        ...
        <section id="issue" className="mt-32 scroll-mt-24 sm:mt-44">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-[18rem_1fr]">
            <div>
              ...
              <p className="mt-6 font-serif text-base leading-relaxed text-ink-soft">
                If you&rsquo;re an issuer &mdash; a KYC provider, a compliance
                service, a protocol team &mdash; you can grant credentials that
                any agent can verify. The web app is read-only by design.
                Issuing requires a private key because only the controller or an
                authorized issuer can write to the registry.
              </p>
              <ul className="mt-4 space-y-2 font-serif text-sm leading-relaxed text-ink-soft">
                <li className="flex items-baseline gap-3">
                  <span className="inline-block h-1 w-1 rounded-full bg-terra" />
