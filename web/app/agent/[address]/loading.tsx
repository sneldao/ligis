    ...
    <main className="mx-auto max-w-5xl px-8 py-16 sm:py-24">
      ...
      <section className="mt-16 grid grid-cols-1 gap-x-12 gap-y-12 sm:grid-cols-[14rem_1fr]">
        <div className="order-2 sm:order-1">
          <div className="aspect-[4/5] w-full max-w-[14rem] bg-paper-deep" aria-hidden />
          <p className="mt-3 font-mono text-[11px] tabular text-ink-quiet">
            portrait pending
          </p>
        </div>
        <div className="order-1 sm:order-2 sm:pt-2">
          <div className="display h-[64px] w-[18rem] bg-paper-deep sm:h-[80px] sm:w-[22rem]" aria-hidden />
      ...
      <section className="mt-24">
        <header className="flex items-baseline justify-between">
          ...
          <p className="font-mono text-[11px] tabular text-ink-quiet">scanning…</p>
        </header>
        <div className="mt-6">
          <Rule />
          {[0, 1, 2].map((i) => (
            <div key={i}>
              <div className="grid grid-cols-[1fr_auto_auto] items-baseline gap-x-8 py-5">
                <div className="h-3 w-48 bg-paper-deep" aria-hidden />
                <div className="h-3 w-20 bg-paper-deep" aria-hidden />
