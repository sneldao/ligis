/**
 * Solidity ABI fragments for the EVM adapter.
 *
 * Single source of truth for any client (CLI, MCP, web) that reads or writes
 * the PharosAgentID + CredentialRegistry contracts directly via viem.
 */
